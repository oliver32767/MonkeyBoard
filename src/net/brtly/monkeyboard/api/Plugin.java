...
/**
 * Annotation that describes an AbstractPanel subclass' entry in the
...
public @interface Plugin {
	public String title();
	public String icon() default "res/img/android.png";
	public boolean allowDuplicates() default true;
}