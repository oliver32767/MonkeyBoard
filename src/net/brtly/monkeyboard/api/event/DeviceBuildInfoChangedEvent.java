...
/**
 * This event is posted whie adb notifies the DeviceManager that a device's
 * build info may have changed
 * 
 * @author obartley
 * 
 */
public class DeviceBuildInfoChangedEvent extends DeviceEvent {

	public DeviceBuildInfoChangedEvent(String serial) {
		super(serial, Type.DEVICE_BUILD_INFO_CHANGED);
	}
